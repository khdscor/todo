...
public class StompChatController {
    ...
    public void enterUser(@Payload StompChatDTO chat, SimpMessageHeaderAccessor headerAccessor) {
    ...
    public void sendMessage(@Payload StompChatDTO chat) {
        log.info("CHAT {}", chat);
    ...
    public void webSocketDisconnectListener(SessionDisconnectEvent event) {
        ...
        if (username != null) {
            ...
            // builder 어노테이션 활용
            StompChatDTO chat = StompChatDTO.builder()
                .type(StompChatDTO.MessageType.LEAVE)
                .sender(username)
